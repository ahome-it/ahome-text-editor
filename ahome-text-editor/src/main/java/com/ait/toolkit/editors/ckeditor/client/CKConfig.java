...
public class CKConfig {
	...
	private native void setNativeShouldEnterSave(boolean enterShouldSave)/*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.keystrokes += [
				13, 'save' ];
	}-*/;
	...
	private native void setNativeReadOnly(boolean readOnly)/*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.readOnly = readOnly;
	}-*/;

	private native void setNativeFileBrowserBrowseUrl(String browseUrl)/*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserBrowseUrl = browseUrl;
	}-*/;

	private native void setNativeFileBrowserImageBrowseUrl(String browseUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserImageBrowseUrl = browseUrl;
	}-*/;

	private native void setNativeFileBrowserImageBrowseLinkUrl(String browseUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserImageBrowseLinkUrl = browseUrl;
	}-*/;

	private native void setNativeEnterMode(String enterMode)/*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.enterMode = enterMode;
	}-*/;

	private native void setToolbarNameObject(String name) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.toolbar = name;
	}-*/;

	private native void setNativeUiColor(String uiColor) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.uiColor = uiColor;
	}-*/;

	private native void setNativeHeight(String height) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.height = height;
	}-*/;

	private native void setNativeWidth(String width) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.width = width;
	}-*/;

	private native void setNativeBaseFloatZIndex(int zIndex) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.baseFloatZIndex = zIndex;
	}-*/;

	private native void setNativeLanguage(String language) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.language = language;
	}-*/;

	private native void setNativeResizeEnabled(boolean resizeEnabled) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.resize_enabled = resizeEnabled;
	}-*/;

	private native void setNativeMaxWidth(int width) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.resize_maxWidth = width;
	}-*/;

	private native void setNativeMinWidth(int width) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.resize_minWidth = width;
	}-*/;

	private native void setNativeMaxHeight(int height) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.resize_maxHeight = height;
	}-*/;

	private native void setNativeMinHeight(int height) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.resize_minHeight = height;
	}-*/;

	private native void setNativeEntities(boolean entities) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.entities = entities;
	}-*/;

	private native void setNativeEntitiesGreek(boolean entitiesGreek) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.entities_greek = entitiesGreek;
	}-*/;

	private native void setNativeEntitiesLatin(boolean entitiesLatin) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.entities_latin = entitiesLatin;
	}-*/;

	private native void setToolbarObject(JavaScriptObject toolbarArray) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.toolbar_temp = toolbarArray;
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.toolbar = 'temp';
	}-*/;

	private native void setNativeTableResize(boolean tableResize) /*-{
		if (tableResize) {
			this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.extraPlugins = 'tableresize';
		} else {
			this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.extraPlugins = '';
		}
	}-*/;

	private native void setNativeTabIndex(int tabIndex) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.tabIndex = tabIndex;
	}-*/;

	private native void setNativeFocusOnStartup(boolean focus) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.startupFocus = focus;
	}-*/;

	private native void setNativeFilebrowserFlashBrowseUrl(String fileBrowserFlashBrowserUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.fileBrowserFlashBrowserUrl = fileBrowserFlashBrowserUrl;
	}-*/;

	private native void setNativeFilebrowserUploadUrl(String filebrowserUploadUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserUploadUrl = filebrowserUploadUrl;
	}-*/;

	private native void setNativeFilebrowserImageUploadUrl(String filebrowserImageUploadUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserImageUploadUrl = filebrowserImageUploadUrl;
	}-*/;

	private native void setNativeFilebrowserFlashUploadUrl(String filebrowserFlashUploadUrl) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.filebrowserFlashUploadUrl = filebrowserFlashUploadUrl;
	}-*/;

	private native void addNativeFontName(String fontName) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.font_names = this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.font_names
				+ ";" + fontName;
	}-*/;

	private native void setNativeExtraPlugins(String extraPlugin) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.extraPlugins = extraPlugin;
	}-*/;

	private native void setNativeTopSharedSpace(String divId) /*-{
		if (this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.sharedSpaces == null) {
			this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.sharedSpaces = {};
		}
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.sharedSpaces.top = divId;
	}-*/;
	...
	private native void setNativeBottomSharedSpace(String divId) /*-{
		...
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.sharedSpaces.bottom = divId;
	}-*/;

	private native void setNativeToolbarCanCollapse(boolean canCollapse) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.toolbarCanCollapse = canCollapse;
	}-*/;
	...
	public native void clearFontNames() /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.font_names = "";
	}-*/;
	...
	private native void addNativeFontSize(String fontSize) /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.fontSize_sizes = this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.fontSize_sizes
				+ ";" + fontSize;
	}-*/;
	...
	public native void clearFontSizes() /*-{
		this.@com.ait.toolkit.editors.ckeditor.client.CKConfig::config.fontSize_sizes = "";
	}-*/;
